...
void setup() {
  ...
  //PostRequest post = new PostRequest("http://127.0.0.1:8000/api/v2/midi/1/3/", "UTF-8");
  //post.send();
  //String midiPath = post.getContent();
  //println(midiPath);
  //midiPlayer.load(midiPath.replaceAll("\"", ""));
  //midiPlayer.load(" C:\\Users\\samdasu\\mididice\\mididice\\midiresult\\1.mid");
  //midiPlayer.load("C:\\Users\\samdasu\\mididice\\mididice\\midiresult\\2c4195f5b06c4419bf7203b1d77fb178.mid");
  //midiPlayer.start();
